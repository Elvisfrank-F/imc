...
final salvarImcCommand = SalvarImcCommand(repositoryImcHistory);
final deleteImcCommand = DeleteImcCommand(repositoryImcHistory);

  final repositoryGifImc = GifImcRepositoryImpl();
final commandGifImc = GifImcCommand(repositoryGifImc);
